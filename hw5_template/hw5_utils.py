...
def line_plot(*data, min_k=2, output_file='output.pdf', save=False):
    """
...
def scatter_plot_2d_project(*data, output_file='output.pdf', ncol=3, save=False):
    """
...
def gaussian_plot_2d_project(mu, variances, *data, output_file='output.pdf', ncol=3, save=False):
    """
    Plots the scatter plot of the given data
